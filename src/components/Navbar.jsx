  ...
  return (
    <div className="w-100vw h-[75px] border-b-2 bg-black z-10">
      <div className="flex sm:justify-between sm:pt-[18px] sm:pl-[79px] ">
        ...
        <div
          className="hidden sm:block relative bottom-[8px] right-[150px] bg-transparent rounded-md hover:cursor-pointer transition duration-300 ease-in-out 
        ...
        <img
          className="block sm:hidden absolute w-[30px] h-[30px] mt-[20px] ml-[330px] bg-white rounded-2xl hover:scale-125 duration-300"
          src={mobileSignIn}
          alt="Mobile Sign-in"
        />
      </div>
      <img
        className="sm:w-[100vw] sm:h-[6px] sm:mt-1 h-[6px] mt-4.5"
        src={rect3}
      />
    </div>
  );
